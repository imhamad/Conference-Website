...
class __TwigTemplate_713e70e87bce6eb3fe56d0ecde97d597111168412ada43ec2c0a25f190d5ba5d extends \Twig\Template
{
...
\t\t{% if content.field_timer | render %}
\t\t<div class=\"countdown-wrap\" data-animation-in=\"bounceInDown\" data-animation-out=\"animate-out slideOutUp\">{{ content.field_timer }}</div>
\t\t{% endif %}
...
\t\t\t{{ content.field_pre_heading_text }}
\t\t</div>
\t\t{% endif %}
...
\t\t<a class=\"slide-button-link button\" href=\"{{ content.field_link.0['#url'] }}\">{{ content.field_link.0['#title'] }}</a>
\t\t</div>
\t\t{% endif %}
\t\t</div>
\t\t</div>
...
\t</div>
\t{% endif %}
</div>", "themes/pana/templates/node/node--slide.html.twig", "/Users/hamad/WebServer/mastersconference/themes/pana/templates/node/node--slide.html.twig");
    }
}
